  ...
  return (
    ...
    >
      <div className="flex flex-col items-center text-center space-y-6 py-4">
        <div className="w-20 h-20 rounded-full bg-[#E8580C]/20 flex items-center justify-center">
          <Award className="w-10 h-10 text-[#E8580C]" />
        </div>

        <div className="space-y-2">
          <p className="text-[#E8E8ED] text-lg">
