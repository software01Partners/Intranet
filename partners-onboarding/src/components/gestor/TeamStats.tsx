    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-[#7A7468] dark:text-[#9A9590] mb-1">
                Colaboradores na Área
              </p>
              <p className="text-2xl font-semibold text-[#2D2A26] dark:text-[#E8E5E0]">
                {stats.totalMembers}
              </p>
            </div>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-[#7A7468] dark:text-[#9A9590] mb-1">Progresso Médio</p>
              <div className="mt-2">
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-[#7A7468] dark:text-[#9A9590] mb-1">Atrasados</p>
              <p className="text-2xl font-semibold text-[#2D2A26] dark:text-[#E8E5E0]">
